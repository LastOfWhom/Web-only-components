...
<!--            </div>-->
                            ...
                            <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                                <div class="d-flex flex-row align-items-center">
                                    <span class="status status-success mr-3">
                                        <span class="rounded-circle profile-image d-block " style="background-image:url('avatar-b.png'); background-size: cover;"></span>
                                    </span>
                                    <div class="info-card-text flex-1">
                                        ...
                                        <?php if(isset($_SESSION['role']['1']) || $_SESSION['auth_user_id'] == $post['id']):?>
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item" href="/edit?id=<?php echo $post['id']?>">
                                                    <i class="fa fa-edit"></i>
                                                Редактировать</a>
                                                <a class="dropdown-item" href="/security?id=<?php echo $post['id']?>">
                                                    <i class="fa fa-lock"></i>
                                                Безопасность</a>
                                                <a class="dropdown-item" href="/status?id=<?php echo $post['id']?>">
                                                    <i class="fa fa-sun"></i>
                                                Установить статус</a>
                                                <a class="dropdown-item" href="/avatar?id=<?php echo $post['id']?>">
                                                    <i class="fa fa-camera"></i>
                                                    Загрузить аватар
                                                </a>
                                                <a href="/delete?id=<?php echo $post['id']?>" class="dropdown-item" onclick="return confirm('are you sure?');">
        ...
        <footer class="page-footer" role="contentinfo">
            <div class="d-flex align-items-center flex-1 text-muted">
                <span class="hidden-md-down fw-700">Учебный проект</span>
            </div>
            <div>
